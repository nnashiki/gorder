...
type Product struct {
	...
	Price     uint64    `boil:"price" json:"price" toml:"price" yaml:"price"`
...
var ProductWhere = struct {
	...
	Price     whereHelperuint64
	CreatedAt whereHelpernull_Time
	UpdatedAt whereHelpernull_Time
}{
	ID:        whereHelperuint64{field: "`products`.`id`"},
	Name:      whereHelperstring{field: "`products`.`name`"},
	Price:     whereHelperuint64{field: "`products`.`price`"},
...
var (
	productAllColumns            = []string{"id", "name", "price", "created_at", "updated_at"}
	productColumnsWithoutDefault = []string{"name", "created_at", "updated_at"}
	productColumnsWithDefault    = []string{"id", "price"}
...
func FindProduct(ctx context.Context, exec boil.ContextExecutor, iD uint64, selectCols ...string) (*Product, error) {
	productObj := &Product{}
...
func ProductExists(ctx context.Context, exec boil.ContextExecutor, iD uint64) (bool, error) {
	var exists bool
